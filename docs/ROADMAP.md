...
- [x] **Fresh-workspace end-to-end + publish gate** — scratch workspace interview→registry→sweep→report; two consecutive clean weekly runs on CVFREELANCER + CVDIRECTOR; publish-readiness pass.
