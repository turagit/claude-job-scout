...
Loaded on demand by `_cv-optimizer/SKILL.md` after Phase 1 analysis completes. Takes the per-dimension scores, computes the weighted overall, grades, identifies top-5 improvements, and surfaces the strength spotlight.
